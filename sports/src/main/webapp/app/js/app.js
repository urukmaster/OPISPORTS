...
var App = angular.module('angle', [ 'ngRoute', 'ngAnimate', 'ngStorage',
		'ngCookies', 'pascalprecht.translate', 'ui.bootstrap', 'ui.router',
		'oc.lazyLoad', 'cfp.loadingBar', 'ngSanitize', 'ngResource',
		'tmh.dynamicLocale', 'ui.utils' ]);
		...
		.config(
				[
						...
						function($stateProvider, $locationProvider,
							...
							// Set the following to true to enable the HTML5
							// Mode
							// You may have to set <base> tag in index and a
							// routing configuration in your server
							...
							$stateProvider
									...
									.state(
											'app.centrosDistribucion',
											{
												url : '/centrosDistribucion',
												title : 'Centros distribucion',
												templateUrl : helper
														.basepath('centroDeDistribucion.html'),
												resolve : helper.resolveFor(
														'flot-chart',
														'flot-chart-plugins',
														'ui.grid')
									...
									.state(
											'app.agendaReservaciones',
											{
												url : '/agendaReservaciones',
												title : 'Reservaciones',
												templateUrl : helper
														.basepath('agendaReservaciones.html'),
												resolve : helper.resolveFor(
														'jquery-ui',
														'jquery-ui-widgets',
														'moment',
									...
									.state(
											'app.establecimientos',
											{
												...
												templateUrl : helper
														.basepath('establecimientos.html'),
												resolve : helper.resolveFor(
														'flot-chart',
														'flot-chart-plugins',
														'ui.grid')
									...
									.state(
											'app.perfil',
											{
												...
												title : 'Perfil',
												templateUrl : helper
														.basepath('perfil.html')
											})
									.state(
											'app.perfil.informacion',
											{
												url : '/informacion',
												title : 'Informacion',
												templateUrl : helper
														.basepath('perfil-informacion.html'),
												resolve : helper
														.resolveFor(
																'loadGoogleMapsJS',
																function() {
									...
									.state(
											'app.perfil.servicios',
											{
												url : '/servicios',
												title : 'Servicios',
												templateUrl : helper
														.basepath('perfil-servicios.html'),
												resolve : helper.resolveFor(
														'flot-chart',
														'flot-chart-plugins',
														'ui.grid')
									...
									.state(
											'app.perfil.reservaciones',
											{
												url : '/reservaciones',
												title : 'Reservaciones',
												templateUrl : helper
														.basepath('perfil-reservaciones.html')
											})
									.state(
											'app.perfil.reservaciones.calendario',
											{
												url : '/reservaciones',
												title : 'Reservaciones',
												templateUrl : helper
														.basepath('perfil-calendario.html'),
												resolve : helper.resolveFor(
														'jquery-ui',
														'jquery-ui-widgets',
														'moment',
									...
									.state(
											'app.perfil.reservaciones.pendientes',
											{
												url : '/reservaciones',
												title : 'Reservaciones',
												templateUrl : helper
														.basepath('perfil-pendientes.html'),
												resolve : helper.resolveFor(
														'flot-chart',
														'flot-chart-plugins',
														'ui.grid')
									...
									.state(
											'app.perfilEvento.informacion',
											{
												url : '/informacionEvento',
												title : 'Informacion',
												templateUrl : helper
														.basepath('perfilEvento-informacion.html'),
												resolve : helper
														.resolveFor(
																'loadGoogleMapsJS',
																function() {
									...
									.state(
											'app.registrarEventoMasivo',
											{
												url : '/registrarEventoMasivo',
												title : 'Registrar Evento',
												templateUrl : helper
														.basepath('registrarEventoMasivo.html'),
												resolve : helper
														.resolveFor('parsley')
											})
									.state(
											'app.registrarUsuario',
											{
												...
												templateUrl : helper
														.basepath('registrarUsuario.html'),
												resolve : helper
														.resolveFor('parsley')
											})
									.state(
											'app.registrarEstablecimiento',
											{
												url : '/registrarEstablecimiento',
												title : 'Registrar Establecimiento',
												templateUrl : helper
														.basepath('registrarEstablecimiento.html'),
												resolve : helper
														.resolveFor('parsley')
											})
									.state(
											'app.modificarEstablecimiento',
											{
												url : '/modificarEstablecimiento/{id:[0-9]{1,4}}',
												title : 'Modificar Establecimiento',
												templateUrl : helper
														.basepath('modificarEstablecimiento.html'),
												resolve : helper
														.resolveFor('parsley')
											})
									.state(
											'app.actividades',
											{
												...
												templateUrl : helper
														.basepath('actividadesDeportivas.html'),
									...
									.state(
											'app.tipoServicio',
											{
												url : '/tipoServicio',
												templateUrl : helper
														.basepath('servicio.html'),
												title : 'Tipos de Servicio',
												templateUrl : helper
														.basepath('tipoServicios.html'),
									...
									.state(
											'app.inscripciones',
											{
												...
												title : 'Inscripciones',
												templateUrl : helper
														.basepath('dashboard-inscripciones.html')
											})
									...
									.state(
											'app.configuracion.registrarUsuario',
											{
												url : '/datosUsuario',
												title : 'datosUsuario',
												templateUrl : helper
									...
									.state(
											'app.configuracion.cambiarContrasenna',
											{
												url : '/cambiarContrasenna',
												title : 'Cambiar Contraseña',
												templateUrl : helper
														.basepath('configuracion-cambiarContrasenna.html'),
												resolve : helper.resolveFor(
														'ngWig', 'flot-chart',
														'flot-chart-plugins',
														'parsley', 'inputmask',
									...
									.state(
											'app.configuracion.eliminarUsuario',
											{
												url : '/eliminarUsuario',
												title : 'Eliminar Usuario',
												templateUrl : helper
														.basepath('configuracion-eliminarUsuario.html'),
												resolve : helper.resolveFor(
														'ngWig', 'flot-chart',
														'flot-chart-plugins',
														'parsley', 'inputmask',
									...
									.state(
											'app.perfil.reservaciones.torneos',
											{
												url : '/torneos',
												title : 'Torneos',
												templateUrl : helper
														.basepath('perfil-torneos.html'),
												resolve : helper
														.resolveFor('ui.grid')
											})
									// 
		...
		.constant(
				'APP_REQUIRES',
				{
					...
					modules : [
							...
							{
								name : 'angular-md5',
								files : [ 'vendor/angular-md5/md5.js' ]
							},
							{
...
/**
 * ========================================================= Module: modals.js
 * Login Implementa el modal de registro de usuario
 * =========================================================
 */
									...
									$http
											.post(
													'rest/iniciarSesion/validarUsuario',
													{
														correo : $scope.account.email,
														contrasenna : md5
																.createHash($scope.account.password)
													})
											.success(
													function(data) {
														if (data.code == 200) {
...
/**
 * ========================================================= Module:
 * access-register.js Demo for register account api
 * =========================================================
 */

App
		.controller(
				'RegistrarFormController',
				[
						'$scope',
						'$http',
						'$state',
						...
						'$rootScope',
						'$timeout',
						function($scope, $http, $state, md5, $rootScope,
								$timeout) {
...
/**
 * ========================================================= Module:
 * angular-grid.js Example for Angular Grid
 * =========================================================
 */

App.controller('AngularGridController', [
		'$scope',
		'$http',
		function($scope, $http) {
			'use strict';
			...
			// Filter Example
			var irishAthletes = [ 'John Joe Nevin', 'Katie Taylor',
					'Paddy Barnes', 'Kenny Egan', 'Darren Sutherland',
					'Margaret Thatcher', 'Tony Blair', 'Ronald Regan',
					'Barack Obama' ];
			...
			$http.get('server/ag-owinners.json').then(function(res) {
				// basic
				$scope.gridOptions.rowData = res.data;
				$scope.gridOptions.api.onNewRows();
				// filter
		...
		.controller(
				...
				[
						...
						function($scope) {
							...
							$scope.postDemo = {};
							$scope.postDemo.tags = [ 'coding', 'less' ];
							$scope.availableTags = [ 'coding', 'less', 'sass',
									'angularjs', 'node', 'expressJS' ];
							$scope.postDemo.categories = [ 'JAVASCRIPT', 'WEB' ];
							$scope.availableCategories = [ 'JAVASCRIPT', 'WEB',
									'BOOTSTRAP', 'SERVER', 'HTML5', 'CSS' ];
 ...
 * filter: {name: $select.search, age: $select.search}" performs a AND between
 * 'name: $select.search' and 'age: $select.search'. We want to perform a OR.
 */
...
/**
 * ========================================================= Module:
 * calendar-ui.js This script handle the calendar demo with draggable events and
 * events creations =========================================================
 */

// var establecimientoCalendario;

App.controller('AngularCarouselController', [
		"$scope",
		function($scope) {
			...
			function getSlide(target, style) {
				...
				return {
					id : (i + 1),
					label : 'slide #' + (i + 1),
					img : 'http://lorempixel.com/1200/500/' + style + '/'
							+ ((i + 1) % 10),
				...
				[
						...
						function($scope, colors) {
							...
							$scope.pieOptions = {
								...
								segmentStrokeColor : '#fff',
								segmentStrokeWidth : 2,
								percentageInnerCutout : 0, // Setting this to
															// zero convert a
															// doughnut into a
															// Pie
								animationSteps : 100,
		...
		.controller(
				...
				[
						...
						function($scope) {
							...
							// Let's put a sequence number aside so we can use
							// it in the event callbacks
							...
							$scope.smilEvents = {
								...
								draw : function(data) {
									...
									if (data.type === 'line') {
										// If the drawn element is a line we do
										// a simple opacity fade in. This could
										// also be achieved using CSS3
										// animations.
										data.element.animate({
											opacity : {
												// The delay when we like to
												// start the animation
												begin : seq * delays + 1000,
												// Duration of the animation
												dur : durations,
												// The value where the animation
												// should start
												from : 0,
										...
										// Using data.axis we get x or y which
										// we can use to construct our animation
										// definition objects
										var pos1Animation = {
											begin : seq * delays,
											dur : durations,
...
/**
 * ========================================================= Module:
 * code-editor.js Codemirror code editor controller
 * =========================================================
 */
		...
		.controller(
				...
				[
						...
						function($scope, $http, $ocLazyLoad) {
							...
							$scope.editorThemes = [ '3024-day', '3024-night',
									'ambiance-mobile', 'ambiance',
									'base16-dark', 'base16-light',
									'blackboard', 'cobalt', 'eclipse',
									'elegant', 'erlang-dark', 'lesser-dark',
									'mbo', 'mdn-like', 'midnight', 'monokai',
									'neat', 'neo', 'night', 'paraiso-dark',
									'paraiso-light', 'pastel-on-dark',
									'rubyblue', 'solarized', 'the-matrix',
							...
							// Load dinamically the stylesheet for the selected
							// theme
							// You can use ozLazyLoad to load also the mode js
							// based
							// on the file extension that is loaded (see
							// handle_filetree)
							$scope.loadTheme = function() {
								var BASE = 'vendor/codemirror/theme/';
								$ocLazyLoad.load(BASE + $scope.editorOpts.theme
										+ '.css');
							...
							$scope.new_filetree = function() {
								...
								// if we select a leaf -> select the parent
								// folder
...
/**
 * ========================================================= Module:
 * datatable,js Angular Datatable controller
 * =========================================================
 */
		...
		.controller(
				...
				[
						...
						function($scope, $resource, DTOptionsBuilder,
							...
							$resource('server/datatable.json').query().$promise
							...
							function addPerson() {
								$scope.heroes.push(angular
										.copy($scope.person2Add));
								$scope.person2Add = _buildPerson2Add($scope.person2Add.id + 1);
							}
							function modifyPerson(index) {
								$scope.heroes.splice(index, 1, angular
										.copy($scope.person2Add));
								$scope.person2Add = _buildPerson2Add($scope.person2Add.id + 1);
							}
...
/**
 * ========================================================= Module:
 * demo-alerts.js Provides a simple demo for pagination
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * demo-buttons.js Provides a simple demo for buttons actions
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * demo-carousel.js Provides a simple demo for bootstrap ui carousel
 * =========================================================
 */
								...
								slides
										.push({
											image : '//placekitten.com/'
													+ newWidth + '/300',
											text : [ 'More', 'Extra',
													'Lots of', 'Surplus' ][slides.length % 2]
													+ ' '
													+ [ 'Cats', 'Kittys',
															'Felines', 'Cutes' ][slides.length % 2]
										});
							};
							for (var i = 0; i < 2; i++) {
								$scope.addSlide();
...
/**
 * ========================================================= Module:
 * demo-datepicker.js Provides a simple demo for bootstrap datepicker
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * demo-dialog.js Demo for multiple ngDialog Usage - ngDialogProvider for
 * default values not supported using lazy loader. Include plugin in base.js
 * instead. =========================================================
 */

// Called from the route state. 'tpl' is resolved before
App.controller('DialogIntroCtrl', [ '$scope', 'ngDialog', 'tpl',
		function($scope, ngDialog, tpl) {
			'user strict';
				...
				[
						...
						function($scope, $rootScope, ngDialog) {
							...
							$scope.directivePreCloseCallback = function(value) {
								if (confirm('Close it? MainCtrl.Directive. (Value = '
										+ value + ')')) {
									return true;
								}
								return false;
							...
							$scope.preCloseCallbackOnScope = function(value) {
								if (confirm('Close it? MainCtrl.OnScope (Value = '
										+ value + ')')) {
									return true;
								}
								return false;
								...
								ngDialog
										...
										.then(
												function(value) {
													console
															.log(
																	'Modal promise resolved. Value: ',
																	value);
												},
												function(reason) {
													console
															.log(
																	'Modal promise rejected. Reason: ',
																	reason);
												});
							};
										...
										.open({
											...
											controller : [
													...
													function($scope, $timeout) {
														...
														var timeout;
														function count() {
															$scope.exampleExternalData = 'Counter '
																	+ (counter++);
															timeout = $timeout(
																	count, 450);
														}
							...
							$rootScope.$on('ngDialog.opened', function(e,
									$dialog) {
								console.log('ngDialog opened: '
										+ $dialog.attr('id'));
							});

							$rootScope.$on('ngDialog.closed', function(e,
									$dialog) {
								console.log('ngDialog closed: '
										+ $dialog.attr('id'));
							});

							$rootScope.$on('ngDialog.closing', function(e,
									$dialog) {
								console.log('ngDialog closing: '
										+ $dialog.attr('id'));
							});
						} ]);
		...
		.controller(
				...
				[
						...
						function($scope, $resource) {
							...
							// the following allow to request array $resource
							// instead of object (default)
							var actions = {
								'get' : {
									method : 'GET',
									isArray : true
							...
							// Tags inputs
							// -----------------------------------
							var Cities = $resource('server/cities.json', {},
									actions);
...
/**
 * ========================================================= Module:
 * demo-notify.js Provides a simple demo for notify
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * demo-pagination.js Provides a simple demo for pagination
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * demo-panels.js Provides a simple demo for panel actions
 * =========================================================
 */
...
App.controller('PanelsCtrl', [ '$scope', '$timeout',
		function($scope, $timeout) {
			...
			// We can use panel id name for the boolean flag to [un]collapse the
			// panel
			...
			$scope.$on('panel-remove', function(event, id, deferred) {
				...
				// Here is obligatory to call the resolve() if we pretend to
				// remove the panel finally
				// Not calling resolve() will NOT remove the panel
				// It's up to your app to decide if panel should be removed or
				// not
				deferred.resolve();
...
/**
 * ========================================================= Module:
 * demo-popover.js Provides a simple demo for popovers
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * demo-progress.js Provides a simple demo to animate progress bar
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * demo-rating.js Provides a demo for ratings UI
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * demo-timepicker.js Provides a simple demo for bootstrap ui timepicker
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * demo-toaster.js Demos for toaster notifications
 * =========================================================
 */
...
App.controller('ToasterDemoCtrl', [
		...
		function($scope, toaster) {
			...
			$scope.pop = function() {
				toaster.pop($scope.toaster.type, $scope.toaster.title,
						$scope.toaster.text);
			};
...
/**
 * ========================================================= Module:
 * demo-tooltip.js Provides a simple demo for tooltip
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * demo-typeahead.js Provides a simple demo for typeahead
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * flot-chart.js Setup options and data for flot chart directive
 * =========================================================
 */
...
App.controller(
		...
		[
				...
				'ChartData',
				'$timeout',
				function($scope, ChartData, $timeout) {
					'use strict';
					...
					$scope.barOptions = {
						...
						yaxis : {
							position : ($scope.app.layout.isRTL ? 'right'
									: 'left'),
							tickColor : '#eee'
						},
						shadowSize : 0
					...
					// BAR STACKED
					// -----------------------------------
					$scope.barStackeData = ChartData
							.load('server/chart/barstacked.json');
					$scope.barStackedOptions = {
						...
						yaxis : {
							min : 0,
							max : 200, // optional: use it for a clear
										// represetation
							position : ($scope.app.layout.isRTL ? 'right'
									: 'left'),
							tickColor : '#eee'
					...
					// SPLINE
					// -----------------------------------
					$scope.splineData = ChartData
							.load('server/chart/spline.json');
					$scope.splineOptions = {
						series : {
							lines : {
								show : false
						...
						yaxis : {
							min : 0,
							max : 150, // optional: use it for a clear
										// represetation
							tickColor : '#eee',
							position : ($scope.app.layout.isRTL ? 'right'
									: 'left'),
					...
					$scope.$on('panel-refresh', function(event, id) {
						...
						console.log('Simulating chart refresh during 3s on #'
								+ id);
					...
					$scope.$on('panel-remove', function(event, id, deferred) {
						...
						// Here is obligatory to call the resolve() if we
						// pretend to remove the panel finally
						// Not calling resolve() will NOT remove the panel
						// It's up to your app to decide if panel should be
						// removed or not
						deferred.resolve();
...
/**
 * ========================================================= Module:
 * form-imgcrop.js Image crop controller
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * FormValidationController Input validation with UI Validate
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * form-xeditable.js Form xEditable controller
 * =========================================================
 */
						...
						function($scope, editableOptions, editableThemes,
							...
							$scope.showStatus = function() {
								var selected = $filter('filter')(
										$scope.statuses, {
											value : $scope.user2.status
										});
								return ($scope.user2.status && selected.length) ? selected[0].text
										: 'Not set';
							};
							...
							$scope.loadGroups = function() {
								return $scope.groups.length ? null : $http.get(
										'server/xeditable-groups.json')
										.success(function(data) {
											$scope.groups = data;
										});
							};
									...
									.$watch(
											...
											function(newVal, oldVal) {
												if (newVal !== oldVal) {
													...
													$scope.user3.text = selected.length ? selected[0].text
															: null;
												}
											});
...
App.controller('ModalGmapController', [
		'$scope',
		'$modal',
		'$timeout',
		function($scope, $modal, $timeout) {
			...
			var ModalInstanceCtrl = function($scope, $modalInstance, $timeout) {
				...
				$modalInstance.opened.then(function() {
					var position = new google.maps.LatLng(33.790807,
							-117.835734);
					...
					// we use timeout to wait maps to be ready before add a
					// markers
					$timeout(function() {
							...
							var get = function(index, count, success) {
								return $timeout(
										function() {
											...
											result = [];
											for (i = _i = index, _ref = index
													+ count - 1; index <= _ref ? _i <= _ref
													: _i >= _ref; i = index <= _ref ? ++_i
													: --_i) {
												result.push('item #' + i);
											}
...
App.controller('LocalizationController', [ "$rootScope", "tmhDynamicLocale",
		"$locale", function($rootScope, tmhDynamicLocale, $locale) {
		...
		.controller(
				...
				[
						...
						function($rootScope, $scope, $state, $translate,
								$window, $localStorage, $timeout, toggle,
								colors, browser, cfpLoadingBar) {
							"use strict";
							...
							$rootScope.$on('$stateChangeStart', function(event,
								...
								if ($('.wrapper > section').length) // check if
																	// bar
																	// container
																	// exists
							...
							$rootScope.$on('$stateNotFound', function(event,
								...
								console.log(unfoundState.toParams); // {a:1,
																	// b:2}
							...
							// Close submenu when sidebar change from collapsed
							// to normal
							$rootScope
									.$watch(
							...
							$scope.language = {
								...
								init : function() {
									var proposedLanguage = $translate
											.proposedLanguage()
											|| $translate.use();
									var preferredLanguage = $translate
											.preferredLanguage(); // we know
																	// we have
																	// set a
																	// preferred
																	// one in
...
/**
 * ========================================================= Module:
 * masonry-deck.js Demo for Angular Deck
 * =========================================================
 */

App.controller('MasonryDeckController',
		[ '$scope', 'RouteHelpers', function($scope, RouteHelpers) {
			'use strict';
...
App.controller('ChartMorrisController',
		[
				'$scope',
				'$timeout',
				'colors',
				function($scope, $timeout, colors) {
					...
					/*
					 * test data update $timeout(function(){
					 * $scope.chartdata[0].a = 50; $scope.chartdata[0].b = 50; },
					 * 3000);
					 */
					...
					$scope.areaOptions = {
						...
						ykeys : [ "a", "b" ],
						labels : [ "Serie A", "Serie B" ],
						lineColors : [ colors.byName('purple'),
								colors.byName('info') ],
						resize : true
					};
			...
			$scope.getPagedDataAsync = function(pageSize, page, searchText) {
				...
				$timeout(function() {
					...
					if (searchText) {
						...
						$http.get(ngGridResourcePath).success(
								function(largeLoad) {
									var data = largeLoad
						...
						$http.get(ngGridResourcePath).success(
								function(largeLoad) {
									$scope.setPagingData(largeLoad, page,
											pageSize);
								});
					}
				}, 100);
...
/**
 * ========================================================= Module:
 * NGTableCtrl.js Controller for ngTables
 * =========================================================
 */

App.controller('NGTableCtrl', NGTableCtrl);

function NGTableCtrl($scope, $filter, ngTableParams, $resource, $timeout,
		ngTableDataService) {
	'use strict';
	...
	// count per page
		...
		getData : function($defer, params) {
			$defer.resolve(data4.slice((params.page() - 1) * params.count(),
	...
	vm.tableParams2 = new ngTableParams({
		...
		getData : function($defer, params) {
			// use build-in angular filter
			var orderedData = params.filter() ? $filter('filter')(data,
					params.filter()) : data;

			vm.users = orderedData.slice((params.page() - 1) * params.count(),
					params.page() * params.count());
	...
	// count per page
		...
		getData : function($defer, params) {
			...
			/*
			 * direct ajax request to api (perform result pagination on the
			 * server) Api.get(params.url(), function(data) {
			 * $timeout(function() { // update table params
			 * params.total(data.total); // set new data
			 * $defer.resolve(data.result); }, 500); });
			 */
		}
	});

}
NGTableCtrl.$inject = [ "$scope", "$filter", "ngTableParams", "$resource",
		"$timeout", "ngTableDataService" ];
...
/**
 * ========================================================= Module:
 * notifications.js Initializes the notifications system
 * =========================================================
 */
...
/**
 * ========================================================= Module: portlet.js
 * Drag and drop any panel to change its position The Selector should could be
 * applied to any object that contains panel, so .col-* element are ideal.
 * =========================================================
 */
App.controller('portletsController', [ '$scope', '$timeout', '$window',
		function($scope, $timeout, $window) {
			...
			var Selector = '[portlet]', storageKeyName = 'portletState';
			...
			function loadPortletOrder(event) {
				...
				if (data) {
					...
					var porletId = self.id, panels = data[porletId];
			...
			/*
			 * function resetListSize() { $(this).css('min-height', ""); }
			 */
...
App.controller('ChartRickshawController', [
		'$scope',
		function($scope) {
			'use strict';
			...
			$scope.palettes = [ 'spectrum14', 'spectrum2000', 'spectrum2001',
					'colorwheel', 'cool', 'classic9', 'munin' ];
...
/**
 * ========================================================= Module:
 * sidebar-menu.js Handle sidebar collapsible elements
 * =========================================================
 */
		...
		.controller(
				...
				[
						...
						function($rootScope, $scope, $state, $http, $timeout,
							...
							// demo: when switch from collapse to hover, close
							// all items
							$rootScope
									.$watch('app.layout.asideHover',
							...
							var isActive = function(item) {
								...
								if (!item.sref || item.sref == '#') {
									...
									angular.forEach(item.submenu, function(
											value, key) {
										if (isActive(value))
											foundActive = true;
									});
							...
							$scope.loadSidebarMenu = function() {
								...
								var menuJson = 'server/sidebar-menu.json', menuURL = menuJson
...
App.controller('TablexEditableController', [
		'$scope',
		'$filter',
		'$http',
		'editableOptions',
		...
		function($scope, $filter, $http, editableOptions, editableThemes, $q) {
			...
			$scope.loadGroups = function() {
				return $scope.groups.length ? null : $http.get(
						'server/xeditable-groups.json').success(function(data) {
					$scope.groups = data;
				});
			};
			...
			$scope.saveColumn = function(column) {
				...
				angular.forEach($scope.users, function(user) {
					// results.push($http.post('/saveColumn', {column: column,
					// value: user[column], id: user.id}));
				...
				[
						...
						function($scope, $filter) {
							...
							$scope.totalCompleted = function() {
								return $filter("filter")($scope.items,
										function(item) {
						...
						function($scope, uiGridConstants, $http) {
							...
							$scope.gridOptions = {
								...
								data : [ {
									...
									"gender" : "male",
									"company" : "Geekko",
									"acciones" : '<div><button ng-click="">Edit</button></div>'
								} ]
							};
							...
							$http.get('server/uigrid-complex.json').success(
									function(data) {
										data.forEach(function(row) {
											row.registered = Date
													.parse(row.registered);
										});
							...
							$http.get('server/uigrid-100.json').success(
									function(data) {
...
App.controller('uiSelectController', [
		"$scope",
		"$http",
		function($scope, $http) {
			...
			$scope.availableColors = [ 'Red', 'Green', 'Blue', 'Yellow',
					'Magenta', 'Maroon', 'Umbra', 'Turquoise' ];

			$scope.multipleDemo = {};
			$scope.multipleDemo.colors = [ 'Blue', 'Red' ];
			$scope.multipleDemo.selectedPeople = [ $scope.people[5],
					$scope.people[4] ];
			$scope.multipleDemo.selectedPeopleWithGroupBy = [ $scope.people[8],
					$scope.people[6] ];
			$scope.multipleDemo.selectedPeopleSimple = [ 'samantha@email.com',
					'wladimir@email.com' ];
...
/**
 * ========================================================= Module:
 * word-cloud.js Controller for jqCloud
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * animate-enabled.js Enable or disables ngAnimate for element with directive
 * =========================================================
 */
...
/**
 * ========================================================= Module: chart.js
 * Wrapper directive for chartJS. Based on
 * https://gist.github.com/AndreasHeiberg/9837868
 * =========================================================
 */
	...
	return {
		...
		link : function($scope, $elem) {
			...
			$scope.$watch("data", function(newVal, oldVal) {
				...
				chartCreated.update();
				if ($scope.legend)
					angular.element($elem[0]).parent().after(
							chartCreated.generateLegend());
			}, true);
			...
			$scope.$watch("tooltip", function(newVal, oldVal) {
				...
				if (newVal === undefined || !chartCreated.segments)
					return;
				if (!isFinite(newVal) || newVal >= chartCreated.segments.length
						|| newVal < 0)
					return;
...
/**
 * ========================================================= Module:
 * classy-loader.js Enable use of classyloader directly from data attributes
 * =========================================================
 */
		...
		.directive(
				...
				[
						...
						function($timeout, Utils) {
							...
							var $scroller = $(window), inViewFlagClass = 'js-is-in-view'; // a
																							// classname
																							// to
																							// detect
																							// when
								...
								link : function(scope, element, attrs) {
									...
									$timeout(
											function() {
												...
												var $element = $(element), options = $element
														.data();
									...
									function startLoader(element, options) {
										element.ClassyLoader(options).addClass(
												inViewFlagClass);
									}
								}
							};
...
/**
 * ========================================================= Module:
 * clear-storage.js Removes a key from the browser storage via element click
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * filestyle.js Initializes the fielstyle plugin
 * =========================================================
 */
	...
	return {
		...
		controller : [
				...
				function($scope, $element) {
					...
					// old usage support
					options.classInput = $element.data('classinput')
							|| options.classInput;
				...
				function($parse) {
					...
					return {
						...
						link : function(scope, element, attribute) {
							var validate = $parse(attribute.validateSteps)(
									scope), wiz = new Wizard(attribute.steps,
									!!validate, element);
						...
						self.go = function(step) {
							...
							if (angular.isDefined(self.steps[step])) {
								...
								if (self.validate && step !== 1) {
									var form = $(self.element), group = form
											.children().children('div').get(
													step - 2);
...
/**
 * ========================================================= Module:
 * fullscreen.js Toggle the fullscreen mode on/off
 * =========================================================
 */
			...
			element.on('click', function(e) {
				...
				if (screenfull.enabled) {
					...
					if (screenfull.isFullscreen)
						$(this).children('em').removeClass('fa-expand')
								.addClass('fa-compress');
					else
						$(this).children('em').removeClass('fa-compress')
								.addClass('fa-expand');
...
App.directive('loadCss', function() {
	...
	function createLink(uri) {
		var linkId = 'autoloaded-stylesheet', oldLink = $('#' + linkId).attr(
				'id', linkId + '-old');
		...
		return function() {
			return {
				...
				link : function($scope, elem, attrs) {
					...
					// Init chart
					$scope.morrisInstance = new Morris[type](
							$scope.morrisOptions);
...
/**
 * ========================================================= Module:
 * navbar-search.js Navbar search toggler * Auto dismiss on ESC key
 * =========================================================
 */
...
App.directive("now", [ 'dateFilter', '$interval',
...
/**
 * ========================================================= Module
 * panel-tools.js Directive tools to control panels. Allows collapse, refresh
 * and dismiss (remove) Saves panel state in browser storage
 * =========================================================
 */
...
App
							...
							function getTemplate(elem, attrs) {
								...
								if (attrs.toolCollapse)
									temp += templates.collapse.replace(
											/{{panelId}}/g, (elem.parent()
													.parent().attr('id')));
								if (attrs.toolDismiss)
									temp += templates.dismiss;
								if (attrs.toolRefresh)
									temp += templates.refresh
											.replace(/{{ spinner }}/g,
													attrs.toolRefresh);
								return temp;
							}
						...
						function($timeout) {
							...
							return {
								...
								controller : [
										...
										function($scope, $element) {
											...
											// Prepare the panel to be
											// collapsible
											var $elem = $($element), parent = $elem
													.closest('.panel'), // find
																		// the
																		// first
																		// parent
							...
							function savePanelState(id, state) {
								if (!id)
									return false;
								var data = angular
										.fromJson(storage[storageKeyName]);
								if (!data) {
									data = {};
								}
								data[id] = state;
		...
		/**
		 * ========================================================= Refresh
		 * panels [panel-refresh] * [data-spinner="standard"]
		 * =========================================================
		 */
		.directive(
				'panelRefresh',
							...
							return {
								...
								controller : [
										...
										function($scope, $element) {
											...
											$scope.$on('removeSpinner',
													removeSpinner);

											// method to clear the spinner when
											// done
											function removeSpinner(ev, id) {
												if (!id)
													return;
												var newid = id.charAt(0) == '#' ? id
														: ('#' + id);
												angular
														.element(newid)
...
/**
 * ========================================================= Module:
 * play-animation.js Provides a simple way to run animation with a trigger
 * Requires animo.js =========================================================
 */
						...
						function($window, Utils) {
							...
							return {
								...
								link : function(scope, elem, attrs) {
									...
									// Parse animations params and attach
									// trigger to scroll
									var $elem = $(elem), offset = $elem
											.data('offset'), delay = $elem
											.data('delay') || 100, // milliseconds
									...
									// Test an element visibilty and trigger the
									// given animation
									...
									$elem
											.on(
													...
													function() {
														...
														var $elem = $(this), targetSel = $elem
																.data('target'), animation = $elem
																.data('play')
																|| 'bounce', target = $(targetSel);
						...
						function($rootScope, $window, Utils) {
							...
							return {
								...
								link : function(scope, element, attrs) {
									...
									var eventName = Utils.isTouch() ? 'click'
											: 'mouseenter';
									var subNav = $();
									$sidebar
											.on(
									...
									// Allows to close
									if (angular
											.isDefined(attrs.sidebarAnyclickClose)) {
							...
							function sidebarAddBackdrop() {
								...
								$backdrop.insertAfter('.aside-inner').on(
										"click mouseenter", function() {
											removeFloatingNav();
										});
							}

							// Open the collapse sidebar submenu items when on
							// touch devices
							...
							function toggleMenuItem($listItem) {
								...
								var $aside = $('.aside');
								var $asideInner = $('.aside-inner'); // for
																		// top
																		// offset
																		// calculation
								// float aside uses extra padding on aside
								var mar = parseInt($asideInner
										.css('padding-top'), 0)
								...
								var itemTop = ($listItem.position().top + mar)
										- $sidebar.scrollTop();
								...
								subNav
										...
										.css(
												{
													position : $scope.app.layout.isFixed ? 'fixed'
															: 'absolute',
													top : itemTop,
													bottom : (subNav
															.outerHeight(true)
...
App.directive('skycon', function() {
	...
	return {
		...
		link : function(scope, element, attrs) {
			...
			element.html('<canvas width="' + attrs.width + '" height="'
					+ attrs.height + '"></canvas>');
...
/**
 * ========================================================= Module:
 * sparkline.js SparkLines Mini Charts
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * table-checkall.js Tables check all checkbox
 * =========================================================
 */
								...
								function($scope, $element) {
									...
									$element
											.on(
													'change',
													function() {
														var $this = $(this), index = $this
																.index() + 1, checkbox = $this
																.find('input[type="checkbox"]'), table = $this
																.parents('table');
														// Make sure to affect
														// only the correct
														// checkbox column
...
/**
 * ========================================================= Module:
 * tags-input.js Initializes the tag inputs plugin
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * toggle-state.js Toggle a classname from the BODY Useful to change a state
 * that affects globally the entire layout or more than one item Targeted
 * elements must have [toggle-state="CLASS-NAME-TO-TOGGLE"] User no-persist to
 * avoid saving the sate in browser storage
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * trigger-resize.js Triggers a window resize event from any element
 * =========================================================
 */

App.directive("triggerResize", [ '$window', '$timeout',
...
/**
 * ========================================================= Module:
 * validate-form.js Initializes the validation plugin Parsley
 * =========================================================
 */
...
/**
 * ========================================================= Module:
 * vector-map.js.js Init jQuery Vector Map plugin
 * =========================================================
 */
...
App.directive('vectorMap', [
		...
		function(vectorMap) {
			...
			var defaultColors = {
				...
				scaleColors : [ '#878c9a' ], // the color of the region in
												// the serie
			...
			return {
				...
				link : function(scope, element, attrs) {
					...
					var mapHeight = attrs.height || '300', options = {
						markerColor : attrs.markerColor
								|| defaultColors.markerColor,
						bgColor : attrs.bgColor || defaultColors.bgColor,
						scale : attrs.scale || 1,
						scaleColors : attrs.scaleColors
								|| defaultColors.scaleColors,
						regionFill : attrs.regionFill
								|| defaultColors.regionFill,
						mapName : attrs.mapName || 'world_mill_en'
					};

					element.css('height', mapHeight);

					vectorMap.init(element, options, scope.seriesData,
							scope.markersData);
...
App.service('browser', function() {
	...
	var uaMatch = function(ua) {
		...
		var platform_match = /(ipad)/.exec(ua) || /(iphone)/.exec(ua)
				|| /(android)/.exec(ua) || /(windows phone)/.exec(ua)
	...
	// These are all considered mobile platforms, meaning they run a mobile
	// browser
	...
	// These are all considered desktop platforms, meaning they run a desktop
	// browser
...
/**
 * ========================================================= Module:
 * nav-search.js Services to share navbar search functions
 * =========================================================
 */
...
/**
 * ========================================================= Module: notify.js
 * Create a notifications that fade out automatically. Based on Notify addon
 * from UIKit (http://getuikit.com/docs/addons_notify.html)
 * =========================================================
 */
...
/**
 * Notify Addon definition as jQuery plugin Adapted version to work with
 * Bootstrap classes More information
 * http://getuikit.com/docs/addons_notify.html
 */
...
(function($, window, document) {
	...
	var Message = function(options) {
		...
		this.uuid = "ID" + (new Date().getTime()) + "RAND"
		...
		this.element = $(
				...
				'<div class="uk-notify-message alert-dismissable">',
						...
						'<div>' + this.options.message + '</div>', '</div>'
		...
		if (!containers[this.options.pos]) {
			containers[this.options.pos] = $(
					'<div class="uk-notify uk-notify-' + this.options.pos
							+ '"></div>').appendTo('body').on("click",
	...
	$.extend(Message.prototype, {
		...
		status : function(status) {
			...
			this.element.removeClass('alert alert-' + this.currentstatus)
		...
		.provider(
				...
				[
						...
						function(appRequires) {
							...
							// Generates a resolve object by passing script
							// names
							...
							this.resolveFor = function() {
								...
								return {
									deps : [
											...
											'$q',
											function($ocLL, $q) {
												// Creates a promise chain for
												// each argument
												var promise = $q.when(1); // empty
																			// promise
												...
												// check and returns required
												// data
												// analyze module items with the
												// form [name: '', files: []]
												// and also simple array of
												// script files (for not angular
												// js)
												function getRequired(name) {
													if (appRequires.modules)
														for ( var m in appRequires.modules)
															if (appRequires.modules[m].name
																	&& appRequires.modules[m].name === name)
																return appRequires.modules[m];
													return appRequires.scripts
															&& appRequires.scripts[name];
												}
							...
							// not necessary, only used in config block for
							// routes
							this.$get = function() {
								return {
...
/**
 * ========================================================= Module:
 * toggle-state.js Services to share toggle state functionality
 * =========================================================
 */
		...
		function($rootScope) {
			...
			var WordChecker = {
				...
				removeWord : function(phrase, word) {
					if (this.hasWord(phrase, word)) {
						return phrase.replace(new RegExp('(^|\\s)*' + word
								+ '(\\s|$)*', 'g'), '');
					}
				}
			};
			...
			return {
				...
				addState : function(classname) {
					var data = angular
							.fromJson($rootScope.$storage[storageKeyName]);
...
App
		.service(
				...
				[
						"$window",
						"APP_MEDIAQUERY",
						function($window, APP_MEDIAQUERY) {
							'use strict';

							var $html = angular.element("html"), $win = angular
									.element($window), $body = angular
									.element('body');
							...
							return {
								...
								support : {
									transition : (function() {
										var transitionEnd = (function() {
											...
											var element = document.body
													|| document.documentElement, transEndEventNames = {
									...
									animation : (function() {
										...
										var animationEnd = (function() {
											...
											var element = document.body
													|| document.documentElement, animEndEventNames = {
									...
									touch : (('ontouchstart' in window && navigator.userAgent
											.toLowerCase().match(
													/mobile|tablet/))
											|| (window.DocumentTouch && document instanceof window.DocumentTouch)
											|| (window.navigator['msPointerEnabled'] && window.navigator['msMaxTouchPoints'] > 0)
											|| // IE 10
											(window.navigator['pointerEnabled'] && window.navigator['maxTouchPoints'] > 0) || // IE
																																// >=11
									false),
								...
								isInView : function(element, options) {
									...
									var window_left = $win.scrollLeft(), window_top = $win
											.scrollTop(), offset = $element
									...
									if (top + $element.height() >= window_top
											&& top - options.topoffset <= window_top
													+ $win.height()
											&& left + $element.width() >= window_left
											&& left - options.leftoffset <= window_left
													+ $win.width()) {
										return true;
									} else {
										return false;
								...
								langdirection : $html.attr("dir") == "rtl" ? "right"
										: "left",
								isTouch : function() {
...
/**
 * ========================================================= Module:
 * vector-map.js Services to initialize vector map plugin
 * =========================================================
 */
