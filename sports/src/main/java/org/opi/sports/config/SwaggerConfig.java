...
public class SwaggerConfig implements ServletContextAware{
	...
	public SwaggerSpringMvcPlugin customImplementation() {
        ...
        relativeSwaggerPathProvider.setApiResourcePrefix("opi.sports");
        return new SwaggerSpringMvcPlugin(this.springSwaggerConfig)
        .pathProvider(relativeSwaggerPathProvider);
        
	}
	private ApiInfo apiInfo() {
		ApiInfo apiInfo = new ApiInfo("OpiSports API", "API for OpiSports",
				"OpiSports API terms of service", "OpiSports email",
				"OpiSports API Licence Type", "OpiSports API License URL");
		return apiInfo;
	}
