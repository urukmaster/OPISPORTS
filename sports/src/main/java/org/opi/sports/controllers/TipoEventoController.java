 ...
 *
 *Sprint #4 Descripción: Se encarga de gestionar los tipos de eventos desde el front
...
public class TipoEventoController {
	...
	public TipoEventoResponse save(@RequestBody TipoEventoRequest tipoEventoRequest) {
		
		//Tipo Evento Response
		TipoEventoResponse tipoEventoResponse = new TipoEventoResponse();
		//Tipo Evento POJO
		TipoEventoPOJO tipoEventoView =TipoEventoHelper.getInstance().saveTipoEvento(tipoEventoRequest, tipoEventoService);
		
		if(tipoEventoService.exists(tipoEventoView.getIdTipoEvento())){
			tipoEventoResponse.setCode(200);
			tipoEventoResponse.setCodeMessage("El tipo de evento se registro correctamente");
		}else{
			tipoEventoResponse.setCode(401);
			tipoEventoResponse.setCodeMessage("El tipo de evento no se registro");
		}
		
		//Inicializacion de los tipos de eventos
		List<TipoEvento> tipoEventoList = tipoEventoService.getAllTipoEvento();
		...
		for(TipoEvento tipoEvento : tipoEventoList){
			tipoEventoViewList.add(TipoEventoHelper.getInstance().convertirTipoEvento(tipoEvento));
		}
	...
	public TipoEventoResponse update(@RequestBody TipoEventoRequest tipoEventoRequest) {
		
		//Tipo Evento Response
		TipoEventoResponse tipoEventoResponse = new TipoEventoResponse();
		//Tipo Evento POJO
		TipoEventoPOJO tipoEventoView =TipoEventoHelper.getInstance().updateTipoEvento(tipoEventoRequest, tipoEventoService);
		
		if(tipoEventoService.exists(tipoEventoView.getIdTipoEvento())){
			tipoEventoResponse.setCode(200);
			tipoEventoResponse.setCodeMessage("El tipo de evento se actualizo correctamente");
		}else{
			tipoEventoResponse.setCode(401);
			tipoEventoResponse.setCodeMessage("El tipo de evento no se actualizo");
		}
	...
	public TipoEventoResponse delete(@RequestBody TipoEventoRequest tipoEventoRequest) {
		
		//Tipo Evento Response
		TipoEventoResponse tipoEventoResponse = new TipoEventoResponse();
		//Tipo Evento POJO
		TipoEventoPOJO tipoEventoView =TipoEventoHelper.getInstance().deleteTipoEvento(tipoEventoRequest, tipoEventoService);
		
		if(tipoEventoService.exists(tipoEventoView.getIdTipoEvento())){
			tipoEventoResponse.setCode(200);
			tipoEventoResponse.setCodeMessage("El tipo de evento se elimino correctamente");
		}else{
			tipoEventoResponse.setCode(401);
			tipoEventoResponse.setCodeMessage("El tipo de evento no se elimino");
		}
